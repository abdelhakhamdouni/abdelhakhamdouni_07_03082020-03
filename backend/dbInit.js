...
connection.connect((err)=>{
    if(err){
        ...
        // create database
        connection.query(`CREATE DATABASE ${dbname} CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci`, (err)=>{
            if(err){
                console.log(err)

                console.log(`something were wrong, uneable to create database ${dbname} please try again!`)
                return process.exit(0);
            }else{
