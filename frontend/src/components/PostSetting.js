...
function PostSetting(props) {
    ...
    function deletethisposte(){
        let confirm = window.confirm('Êtes-vous sur de vouloir suprimer ce poste ?')
        if(confirm){
    ...
    return (
        ...
        <ul className="postSetting">
            <li className="delete" data-id={props.id} onClick={deletethisposte}><span className="fa fa-trash"></span> Suprmier ce poste</li>
        </ul>
    )
}
