                ...
                <div className="comment-footer">
                    {
                        ...
                        <button  onClick={setShow}><span className={!commentshow ?  'fa fa-arrow-left' : "fa fa-times"}></span> {!commentshow ?  "Répondre" : "fermer"}</button>    
                    }
                     {
                        author !== -1 && <button  onClick={deletecomment}><span className="fa fa-times"></span> Supprimer</button>
                     }
                    <button onClick={()=>window.confirm("le commentaire a été signalé a l'adminstrateur du groupe merci!")}><span className="fa fa-exclamation-triangle"></span> Signaler</button>
                </div>
