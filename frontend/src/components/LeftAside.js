...
function LeftAside(props) {
    ...
    return (
        !props.state.showSideBarre ? null :
            <nav className="leftaside" >
                <img src={logo} alt="logo" />
                <h2>{props.state.user.pseudo}</h2>
                <ul>
                    <li>
                        <Link to="/profile" onClick={() => props.toggleSideBarre(!props.state.showSideBarre)}>
                            <span className="fa fa-user"></span>
                            <span>Mon profil</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="/mesposts" onClick={() => props.toggleSideBarre(!props.state.showSideBarre)}>
